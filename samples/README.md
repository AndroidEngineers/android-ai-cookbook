...
Browse [feature guides](../docs/features.md) to find the relevant recipe. Feature folders contain documentation; `recipe-lab` is the runnable Android Studio project. Future independent projects belong here when their runtime or dependencies require separation.
